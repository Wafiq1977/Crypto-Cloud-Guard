  ...
  const onSubmit = (data: LoginForm) => {
    loginMutation.mutate({ data }, {
      ...
      onError: (err: any) => {
        toast({
          title: "Access Denied",
          description: err.message || "Invalid credentials. Incident logged.",
          variant: "destructive",
        });
      }
    });
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-md p-8 bg-black/60 backdrop-blur-2xl border border-primary/30 rounded-xl shadow-[0_0_50px_rgba(0,212,255,0.15)]"
      >
